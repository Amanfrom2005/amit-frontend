      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <div className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            <TextReveal text="Work with Amit and unlock the power of technology and the internet through our wide range of services, including web development, game development, 2D & 3D animation, and more." />
          </div>
